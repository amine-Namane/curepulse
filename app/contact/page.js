      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            <span className="text-blue-600">Contact</span> HealthConnect
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-16">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Contact Information */}
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4">
                Get in Touch
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Healthcare Blvd</p>
          ...
          <div className="mt-12">
            ...
            <div className="bg-gray-200 h-96 rounded-xl overflow-hidden">
              ...
              <iframe
    title="HealthConnect Blida Location"
    width="100%"
    height="100%"
    frameBorder="0"
    scrolling="no"
  ...
  ></iframe>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center mt-12">
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <p className="text-blue-600 font-medium">24/7 Critical Care Line</p>
